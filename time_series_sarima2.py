...
y=data.iloc[100:144,1]
y_forecasted = best_model.predict(start=100, end=143)
mse = ((y_forecasted - y) ** 2).mean()
print('The Mean Squared Error is {}'.format(round(mse, 2)))
print('The Root Mean Squared Error is {}'.format(round(np.sqrt(mse), 2)))
print('MAPE {}'.format(mean_absolute_percentage_error(y, y_forecasted)))

plt.figure(figsize=(17, 8))
plt.plot(data.iloc[100:144,0],y, label="Actual")
plt.plot(data.iloc[100:144,0],y_forecasted, label="Predicted")
plt.title('Passengers Traffic')
plt.ylabel('Number of passengers')
plt.xlabel('Month')
plt.grid(False)
